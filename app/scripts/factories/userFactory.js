...
angular.module('UsersModule', ['constants'])
	...
	.factory('UserFactory', ['usertmp', '$http', 'OAuthToken', '$cookies', 'config',
		function (usertmp, $http, OAuthToken, $cookies, config) {
			var _users;
			var _user;
			var _rules;
			...
			function getUsers(data) {
				...
				angular.forEach(data, function (u, key) {
					tmpUsers.push(usertmp.setUser(u));
				});
				_users = tmpUsers;
			}
